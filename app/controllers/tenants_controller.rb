class TenantsController < ApplicationController
  ...
  def index
    @tenants = Tenant.search(params[:search]).order(sort_column + " " + sort_direction).paginate(:page => params[:page])
  ...
  def destroy
   ...
   private  
      def sort_column  
        Listing.column_names.include?(params[:sort]) ? params[:sort] : "email"  
      end
